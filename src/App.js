...
function App() {
  ...
  return (
    <div className='p-8 flex flex-col justify-center align-center bg-[url("./img/questioning-concept-with-question-mark_23-2150408209.avif")] bg-no-repeat bg-cover bg-center'>
